          ...
          <div className="sign-in-social-submain">
            ...
            <div className="sign-in-social-social">
              ...
              <div classname="sign-in-social-2-2" style={{ flexDirection: 'column', alignContent: 'center' }}>
                <div classname="sign-in-social-2-fb">
                  <FacebookLoginButton style={{ fontSize: '16px' }} onClick={handleLoginWithFacebook} />
                </div>
                <div classname="sign-in-social-2-g">
                  <GoogleLoginButton style={{ fontSize: '16px' }} onClick={handleLoginWithGoogle} />
                </div>
                <div classname="sign-in-social-2-a">
                  <TwitterLoginButton style={{ fontSize: '16px' }} onClick={() => alert('Work In Progress')} />
                </div>
              </div>
            </div>
